/* plugin-build-0.0.1.h generated by valac 0.32.1, the Vala compiler, do not modify */
...
const gchar* bob_builder_build_plugin_build_configuration_get_targetGlib (bobbuilderbuildpluginBuildConfiguration* self);
void bob_builder_build_plugin_build_configuration_set_targetGlib (bobbuilderbuildpluginBuildConfiguration* self, const gchar* value);
