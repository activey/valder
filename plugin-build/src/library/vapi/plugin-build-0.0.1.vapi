/* plugin-build-0.0.1.vapi generated by valac 0.32.1, do not modify. */
		...
		namespace build {
			namespace plugin {
				...
				public class BuildConfiguration {
					...
					public bob.builder.build.plugin.CCOptions ccOptions { get; set; }
					public bool debug { get; set; }
					public GLib.List<bob.builder.recipe.project.BobBuildProjectDependency> dependencies { get; }
					public bob.builder.build.plugin.GirConfiguration girConfiguration { get; set; }
					...
					public bob.builder.build.plugin.VapiConfiguration vapiConfiguration { get; set; }
				...
				public class BuildConfigurationBuilder {
					...
					public bob.builder.build.plugin.BuildConfigurationBuilder girLibraryName (string girLibraryName);
					public bob.builder.build.plugin.BuildConfigurationBuilder girLibraryVersion (string girLibraryVersion);
					public bob.builder.build.plugin.BuildConfigurationBuilder girOutputDirectory (string girOutputDirectory);
				...
				public class GIRGenerator {
					public GIRGenerator ();
					public void generateGIRRepositoryFile (Vala.CodeContext codeContext, bob.builder.build.plugin.GirConfiguration girConfiguration);
				}
				[CCode (cheader_filename = "src/library/vala/bob/builder/build/plugin/BuildConfiguration.h")]
