/* bob-builder.vapi generated by valac-0.26 0.26.1.9-22126, do not modify. */
		...
		namespace bob {
			...
			namespace build {
				namespace plugin {
					...
					public class BobBuildPluginExecutionChain {
						...
						public com.futureprocessing.bob.build.plugin.BobBuildPluginInstance? getPlugin (string pluginName);
						public void preparePlugin (com.futureprocessing.bob.recipe.plugin.BobBuildPluginRecipe pluginRecipe);
					}
					[CCode (cheader_filename = "bob-builder.h")]
					public class BobBuildPluginInstance : GLib.Object {
						public BobBuildPluginInstance (string pluginName, com.futureprocessing.bob.build.plugin.BuildPluginLoader pluginLoader);
						public void preparePlugin (com.futureprocessing.bob.recipe.plugin.BobBuildPluginRecipe pluginRecipe);
						public string pluginName { get; set construct; }
					}
					[CCode (cheader_filename = "bob-builder.h")]
					public class BuildPluginLoader : GLib.TypeModule {
						public BuildPluginLoader (string name);
						public string[] getPluginDependencies ();
						public com.futureprocessing.bob.build.plugin.BobBuildPlugin instantiatePlugin ();
			...
			namespace recipe {
				...
				public class BobBuildRecipe : GLib.Object {
					...
					public GLib.List<com.futureprocessing.bob.recipe.plugin.BobBuildPluginRecipe> plugins { get; set; }
