...
namespace com.futureprocessing.bob.build.plugin {
	...
	public errordomain BuildPluginError {
        PLUGINS_FOLDER_MISSING, MODULE_NOT_FOUND_ERROR, MODULE_TYPE_FUNCTION_MISSING_ERROR, DEPENDENCY_MISSING
    }
	...
	public class BobBuildPluginLoader {
	  ...
	  //   private void loadPluginDependencies(Module module) throws BuildPluginError {
